...
<html lang="en">
  <head>
    ...
    <title>Demo responsive Bootstrap Ajax Crud</title>
  ...
  $.ajax({
    ...
    success: function(data) {
      if ((data.errors)) {
        ...
        //$('.error-title').remove();
        $('.error-title').addClass('hidden');   //hide to ensure able to remove hidden class on next click
        $('.error-description').addClass('hidden'); //ditto
...
//add my func to clear error messages if input fields have > 0 chars in them
